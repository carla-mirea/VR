...
namespace rt
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                new Ellipsoid(new Vector(  0.0, -25.0, 100.0), new Vector(3.0, 3.0, 3.0), 5.0, Color.WHITE),
                
                new Ellipsoid(new Vector( 15.0, -25.0, 100.0), new Vector(10.0, 3.0, 3.0), 5.0, Color.RED),
                new Ellipsoid(new Vector( 35.0, -25.0, 100.0), new Vector(10.0, 3.0, 3.0), 5.0, Color.RED),
                new Ellipsoid(new Vector( 55.0, -25.0, 100.0), new Vector(10.0, 3.0, 3.0), 5.0, Color.RED),
                
                new Ellipsoid(new Vector(  0.0, -10.0, 100.0), new Vector(3.0, 10.0, 3.0), 5.0, Color.GREEN),
                new Ellipsoid(new Vector(  0.0,  10.0, 100.0), new Vector(3.0, 10.0, 3.0), 5.0, Color.GREEN),
                new Ellipsoid(new Vector(  0.0,  30.0, 100.0), new Vector(3.0, 10.0, 3.0), 5.0, Color.GREEN),
                
                new Ellipsoid(new Vector(  0.0, -25.0, 115.0), new Vector(3.0, 3.0, 10.0), 5.0, Color.BLUE),
                new Ellipsoid(new Vector(  0.0, -25.0, 135.0), new Vector(3.0, 3.0, 10.0), 5.0, Color.BLUE),
                new Ellipsoid(new Vector(  0.0, -25.0, 155.0), new Vector(3.0, 3.0, 10.0), 5.0, Color.BLUE),
                
                new Ellipsoid(new Vector( 35.0,  10.0, 100.0), new Vector(6.0, 6.0, 6.0), 5.0, Color.YELLOW),
                new Ellipsoid(new Vector(  0.0,  10.0, 135.0), new Vector(10.0, 10.0, 10.0), 5.0, Color.CYAN),
                new Ellipsoid(new Vector( 35.0, -25.0, 135.0), new Vector(15.0, 15.0, 15.0), 5.0, Color.MAGENTA),
